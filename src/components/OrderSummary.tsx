...
const OrderSummary = () => {
  ...
  return (
    <div className=" lg:w-80 w-full h-full bg-blue-400 bg-opacity-35 rounded">
      ...
      <div className="px-4 pb-6">
        ...
        <button
          ...
          className="bg-purple-500 px-3 py-2 text-white  mt-2 rounded-md w-full text-xs flex justify-between items-center mb-4"
        >
        ...
        <button
          ...
          className="bg-blue-600 px-3 py-2 text-white  mt-2 rounded-md w-full text-xs flex justify-between items-center"
        >
