  ...
  return (
    <div className="min-h-screen  py-16 mt-10">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-3xl font-bold text-slate-600 mb-2">Contact Us</h1>
        </motion.div>
        <div className="max-w-7xl mx-auto bg-slate-400 shadow-lg rounded-lg p-6 w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="">
              ...
              <p className="text-white mb-6">
                Have a question or want to reach out? We'd love to hear from
                you!
              </p>
              <div className="mb-4">
            ...
            <div>
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-white  text-black  hover:bg-slate-500 hover:text-white text-xl font-bold py-2 px-4 rounded shadow-md transition duration-300 mb-4"
                >
                  Submit
                </button>
              </form>
